...
impl RtcpPacketType {
    ...
    pub fn value(&self) -> u8 {
        match self {
            ...
            RtcpPacketType::ApplicationDefined => 204,
...
pub enum RtcpPacket {
    ...
    ApplicationDefined(packets::RtcpPacketApplicationDefined),
...
impl RtcpPacket {
        ...
        match RtcpPacketType::from(buffer[1]) {
            Some(packet_type) => {
                ...
                match packet_type {
                    ...
                    RtcpPacketType::ApplicationDefined => Ok(RtcpPacket::ApplicationDefined(packets::RtcpPacketApplicationDefined::parse(&mut reader)?)),
    ...
    pub fn write(&self, buffer: &mut [u8]) -> Result<usize> {
        ...
        match self {
            ...
            RtcpPacket::ApplicationDefined(packet) => packet.write(&mut writer),
